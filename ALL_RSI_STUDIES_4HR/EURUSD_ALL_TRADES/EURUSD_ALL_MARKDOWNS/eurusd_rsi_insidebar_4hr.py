...
# ==========================================
# INSIDE BAR LOGIC
# Current candle high is lower than previous high
# Current candle low is higher than previous low
# ==========================================
...
bullish = signals[signals["signal"] == "BULLISH_INSIDE_BAR"]
bearish = signals[signals["signal"] == "BEARISH_INSIDE_BAR"]
...
# ==========================================
signals.to_csv(
    "eurusd_h4_rsi_insidebar_results.csv",
    index=False
)
