...
print(f"Rows Loaded: {len(h4)}")

# ==========================================
# BUILD DAILY STRUCTURE FROM H4 DATA
# ==========================================
daily = h4.groupby("trade_date").agg(
    daily_high=("high", "max"),
    daily_low=("low", "min")
).reset_index()
...
df = pd.merge(
    h4,
    daily[["trade_date", "prev_day_high", "prev_day_low"]],
    on="trade_date",
    how="left"
)
...
# ==========================================
# DISTANCE TO PREVIOUS DAILY LEVELS
# ==========================================
...
# ==========================================
signals.to_csv(
    "eurusd_h4_rsi_daily_structure_results.csv",
    index=False
)
