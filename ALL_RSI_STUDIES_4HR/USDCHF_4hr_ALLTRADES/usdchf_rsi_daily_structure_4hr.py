...
# =========================
# CREATE DAILY STRUCTURE FROM H4 DATA
# =========================
...
levels = daily[["trade_date", "prev_day_high", "prev_day_low"]]
...
signals.to_csv(
    "usdchf_h4_rsi_daily_structure_results.csv",
    index=False
)
