...
# How close price must be to prior daily high/low
# 0.10% = close enough for first test
NEAR_LEVEL_PCT = 0.10
...
# =========================
# RSI + STRUCTURE SIGNALS
# =========================

df["signal"] = None

# Bearish idea:
# Price near previous daily high + RSI overbought
...
df.loc[
    ...
    "signal"
] = "RSI_OVERBOUGHT_AT_PREV_HIGH"

# Bullish idea:
# Price near previous daily low + RSI oversold
...
bullish = signals[
    signals["signal"] == "RSI_OVERSOLD_AT_PREV_LOW"
]

bearish = signals[
    signals["signal"] == "RSI_OVERBOUGHT_AT_PREV_HIGH"
]
...
print("\n===== RSI + PREVIOUS DAILY HIGH/LOW RESEARCH =====\n")
...
signals.to_csv(
    "eurusd_rsi_prev_high_low_results.csv",
    index=False
)
