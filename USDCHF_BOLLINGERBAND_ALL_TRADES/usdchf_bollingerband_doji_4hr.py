...
bullish = signals[
    signals["signal"] == "BB_DOJI_BULLISH"
]

bearish = signals[
    signals["signal"] == "BB_DOJI_BEARISH"
]
...
# OUTPUT
# ==========================================
print("\n===== USDCHF H4 BOLLINGER BAND + DOJI =====\n")

print(f"Table Tested: {TABLE_NAME}")
print(f"BB Period: {BB_PERIOD}")
print(f"BB Std Dev: {BB_STD}")
print(
    f"Doji Body Threshold: "
    f"{DOJI_BODY_PCT * 100:.0f}% of candle range"
)
