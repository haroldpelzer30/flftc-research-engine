...
bullish = signals[signals["signal"] == "BB_INSIDE_BAR_BULLISH"]
bearish = signals[signals["signal"] == "BB_INSIDE_BAR_BEARISH"]
...
# OUTPUT
# ==========================================
print("\n===== EURUSD H4 BOLLINGER BAND + INSIDE BAR =====\n")
...
# ==========================================
signals.to_csv(
    "eurusd_bb_insidebar_results.csv",
    index=False
)
